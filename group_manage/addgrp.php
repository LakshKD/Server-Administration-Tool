<html>
	...
	<body>
		...
		<center><img src=gc.gif><img src=rc.gif><img src=o.gif><img src=u.gif><img src=p.gif>&nbsp;&nbsp;&nbsp;<img src=m.gif><img src=as.gif><img src=ns1.gif><img src=as.gif><img src=g.gif><img src=es.gif><img src=ms.gif><img src=es.gif><img src=ns1.gif><img src=ts.gif><br>
			...
			<h1><b><u>ADD GROUPS</u></b></h1>
		<form action="" method="post">
		<table height=30% width=40% bgcolor=#cccccc border=0>
		<tr height=4% bgcolor=#9999ff><td>&nbsp;&nbsp;&nbsp;&nbsp;Add Groups</td><td width=2%></td><td width=13%></td></tr>
		<tr height=3% width=40%>
		<td width=15%>&nbsp;&nbsp;&nbsp;&nbsp;Enter group</td>
		<td width=2%> : </td><td width=13%><input type="text" name="nam"></td></tr>
		<tr height=5%><th><input type="submit" name="sub" value="ADD GROUPS"></th></tr>
		</table>		
		</form>
		<center>
		<?php
			if(isset($_POST['sub']))
			{
				if($_POST['nam']=="")
					...
					$x=explode($a,$o);
					if($x[1]!="")
				        echo "<b><i>GROUP \"$a\"EXISTS !!!!</i></b>";
					else
						{
					$b=`sudo groupadd $a`;
					echo "<b>GROUP&nbsp;&nbsp;&nbsp;<i><u>$a</u></i>&nbsp;&nbsp;&nbsp;ADDED</b>";
						}
					}
			}
		?><br><hr></center></center>
