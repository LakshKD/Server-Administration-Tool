<html>
	<head>
		<title>Create Forward Zone</title>
	</head>
	<body>
		<a href=/index.php>Main index</a><br>
		<a href=dns.php>Module index</a>
		<center>
		<center><img src=b.gif><img src=i.gif><img src=n.gif><img src=d.gif>&nbsp;&nbsp;&nbsp;<img src=d.gif><img src=n.gif><img src=s.gif>&nbsp;&nbsp;&nbsp;<img src=s.gif><img src=es.gif><img src=r.gif><img src=v.gif><img src=es.gif><img src=r.gif>
			<br>
		Berkeley Internet Name Domain RHEL 6.0<hr>
		<h1><b><u>CREATE FORWARD ZONE</u></b></h1>
		<table border=2><tr><th><img src=forward.gif></th><tr></table><hr>
		<form action="" method="post">
		<table height=40% width=40% bgcolor=#cccccc border=0>
		<tr height=3% width=40% bgcolor=#9999ff>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;Create a Forward Zone</td>
		...
		<tr height=10%><th>
		<input type="submit" name="submit" value="Create Forward Zone"></th></tr>
		</table><br>
		</form>
		<?php
...
$x;
				...
				echo "FORWARD ZONE<br><br><img src=forward.gif><br><br>&nbsp;&nbsp;<u><b><i>$a</i></u></b>&nbsp;&nbsp;CREATED";
					}
				}
			}
                 	?></center></center><hr><br>
