<html>
	<head>
		<title>Name Alias Records</title>
	</head>
	<body>
		...
		<table border=2><tr><th><img src=cname.gif></th><tr></table>
		<h1><b><u>NAME ALIAS RECORDS</u></b></h1><hr>
		<form action="" method="post">
		<table height=40% width=60% bgcolor=#cccccc border=0>
		<tr height=3% width=60% bgcolor=#9999ff>
		<td>&nbsp;&nbsp;&nbsp;Name Alias Records</td>
		...
		<td width=50%>
		&nbsp;&nbsp;&nbsp;Enter The Name Alias For The Domain Name (Must end With dot(.))</td><td width=2%> : </td><td width=18%><input type="text" name="namealias"></td></tr>
		<tr height=10%><th>
		<input type="submit" name="submit" value="Create Name Alias"></th></tr>
		</table><br>
		</form>
		<?php
		if(isset($_POST['submit']))
			...
			if($_POST['namealias']==""&&$_POST['domain']!="")
				echo "<b>NAME ALIAS RECORD CAN NOT BE BLANK!!!";
			}
		if(isset($_POST['submit'])&&$_POST['domain']!=""&&$_POST['namealias']!="")
			{
				$a=$_POST['domain'];
				...
				else
				{
					    ...
					    echo "NAME ALIAS RECORD<br><br>&nbsp;&nbsp;<u><b><i>$f</i></u></b>&nbsp;&nbsp;CREATED";
				}
			}
		?></center></center><br><hr>
		<form action="" method=post>
