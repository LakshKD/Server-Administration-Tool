<html>
	<head>
		<title>IPP Service Management</title>
	</head>
	<body>
		...
		<?php
			...
			{
			 $a=`sudo /etc/init.d/cups start`;
			 echo "<pre>$a</pre>"."<br>"."<b><u>IPP SERVICE STARTED</u></b>";
			}
			if(isset($_POST['stop']))
			{
			 $b=`sudo /etc/init.d/cups stop`;
			 echo "<pre>$b</pre>"."<br>"."<b><u>IPP SERVICE STOPED</u></b>";
			}
			if(isset($_POST['status']))
			{
			 $c=`sudo /etc/init.d/cups status`;
			 echo "<pre>$c</pre>"."<br>";
			}
			if(isset($_POST['restart']))
			{
			 $d=`sudo /etc/init.d/cups restart`;
			 echo "<pre>$d</pre>"."<br>"."<b><u>IPP SERVICE RESTARTED</u></b>";
			}
		?></center>
		<br><hr></center>
