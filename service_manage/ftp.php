<html>
	<head>
		<title>FTP Service Management</title>
	</head>
	<body>
		...
		<?php
			...
			{
			 $a=`sudo service vsftpd start`;
			 echo "<pre>$a</pre>"."<br>"."<b><u>FTP SERVICE STARTED</u></b>";
			}
			if(isset($_POST['stop']))
			{
			 $b=`sudo service vsftpd stop`;
			 echo "<pre>$b</pre>"."<br>"."<b><u>FTP SERVICE STOPED</u></b>";
			}
			...
			if(isset($_POST['restart']))
			{
			 ...
			 echo "<pre>$d</pre>"."<br>"."<b><u>FTP SERVICE RESTARTED</u></b>";
			}
		?></center>
		<br><hr></center>
