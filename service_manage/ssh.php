<html>
	<head>
		<title>SSH Service Management</title>
	</head>
	<body>
		...
		<?php
			...
			{
			 $a=`sudo /etc/init.d/sshd start`;
			 echo "<pre>$a</pre>"."<br>"."<b><u>SSH SERVICE STARTED</u></b>";
			}
			if(isset($_POST['stop']))
			{
			 $b=`sudo /etc/init.d/sshd stop`;
			 echo "<pre>$b</pre>"."<br>"."<b><u>SSH SERVICE STOPED</u></b>";
			}
			if(isset($_POST['status']))
			{
			 $c=`sudo /etc/init.d/sshd status`;
			 echo "<pre>$c</pre>"."<br>";
			}
			if(isset($_POST['restart']))
			{
			 $d=`sudo /etc/init.d/sshd restart`;
			 echo "<pre>$d</pre>"."<br>"."<b><u>SSH SERVICE RESTARTED</u></b>";
			}
		?></center>
		<br><hr></center>
