<html>
	...
	<body>
		...
		<h1><b><u>TCP Configuration</u></b></h1>
		<table border=2><tr><th><img src=tcp.gif></th><tr></table><hr>
		<form action="" method="post">
		<table height=50% width=60% bgcolor=#cccccc>
		<tr height=5% bgcolor=#9999ff><td width=40%>&nbsp;&nbsp;&nbsp;&nbsp;configure tcp</td><td width=5%></td><td width=25%></td></tr>
		<tr><td width=30%>
		...
		<tr><td width=30%>
		&nbsp;&nbsp;&nbsp;&nbsp;Enter the port no.</td><td width=5%> : </td><td width=25%><input type="text" name="port"></td></tr>
		<tr><td width=30%>
		...
		<input type="submit" name="submit" value="Configure TCP">
		</th></tr></table>
		</form>
		<?php
			...
			if($_POST['port']==""&&$_POST['accept']!=""&&$_POST['input']!="")
			echo "<b><i>SORRY !!!! PORT NO. CAN NOT BE BLANK !!!!</i></b>";
			if($_POST['ip']==""&&$_POST['port']!=""&&$_POST['accept']!=""&&$_POST['input']!="")
			echo "<b><i>SORRY !!!! IP ADDRESS CAN NOT BE BLANK !!!!</i></b>";
			}
		if(isset($_POST['submit'])&&$_POST['ip']!=""&&$_POST['port']!=""&&$_POST['accept']!=""&&$_POST['input']!="")
	           {
				$a=$_POST['input'];
				$b=$_POST['accept'];
				$c=$_POST['port'];
				...
				echo "<b><i>SORRY !!!! PORT NO. \"$c\" NOT VALID !!!! </i></b>";
		 }
				else
